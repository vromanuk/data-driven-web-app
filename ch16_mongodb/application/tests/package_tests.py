...
def test_package_details_success():
    ...
    from application.pypi_org.views.package_views import package_details
    ...
    # Act
    with unittest.mock.patch('application.pypi_org.services.package_service.get_package_by_id',
