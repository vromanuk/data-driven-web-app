...
from application.pypi_org.data.users import User as SqlUser
from application.pypi_org.nosql.users import User as MongoUser

from application.pypi_org.data.package import Package as SqlPackage
from application.pypi_org.nosql.packages import Package as MongoPackage

from application.pypi_org.data.releases import Release as SqlRelease
from application.pypi_org.nosql.releases import Release as MongoRelease
