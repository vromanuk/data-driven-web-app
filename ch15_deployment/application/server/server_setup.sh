...
# Setup the web app:
cd cd /apps/app_repo/app/ch15_deployment/application/
pip install -r requirements.txt

# Copy and enable the daemon
cp /apps/app_repo/app/ch15_deployment/application/server/pypi.service /etc/systemd/system/pypi.service
...
cp /apps/app_repo/app/ch15_deployment/application/server/pypi.nginx /etc/nginx/sites-enabled/pypi.nginx
